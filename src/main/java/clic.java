...
public class clic {
    public static void main(String[] args) throws IOException, ParseException {
        ...
        document.add(new TextField("content", "Егорушкин Илья Андрееврич", Field.Store.YES));
        writer.addDocument(document);
        document.add(new TextField("content", "Ильич Федор Анатольевич", Field.Store.YES));
        writer.addDocument(document);
